...
public class RecyclerAdapterChain extends RecyclerView.Adapter<RecyclerAdapterChain.ViewHolder> {
    ...
    @NonNull
    @Override
    public RecyclerAdapterChain.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new RecyclerAdapterChain.ViewHolder(mInflater.inflate(R.layout.adapter_linkage_holder, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerAdapterChain.ViewHolder holder, int position) {
